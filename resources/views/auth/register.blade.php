            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="patient_name" class="col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="disease" class="col-md-4 col-form-label text-md-end">{{ __('Disease') }}</label>

                            <div class="col-md-6">
                                <input id="disease" type="text" placeholder="Please Specify your disease" class="form-control @error('disease') is-invalid @enderror" name="disease" value="{{ old('disease') }}" required autocomplete="disease">
